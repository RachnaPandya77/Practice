...
int main() {
    ...
    // Taking input for dimensions of first matrix
    printf("Enter the number of rows of first matrix: ");
    scanf("%d", &rows1);
    printf("Enter the number of columns of first matrix: ");
    scanf("%d", &cols1);

    // Taking input for dimensions of second matrix
    ...
    // Multiplying matrices and storing result in 'result'
    multiplyMatrices(rows1, cols1, matrix1, rows2, cols2, matrix2, result);

    // Displaying the result matrix after multiplication
